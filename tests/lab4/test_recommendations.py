import unittest
from src.lab4.task1.main import Recommendations_system

class TestRecommendationsSystem(unittest.TestCase):

    def setUp(self):
        self.recSystem = Recommendations_system('src/lab4/task1/files/films.txt', 'src/lab4/task1/files/history.txt')

    def test_check_films(self):
        self.assertEqual(self.recSystem.check_films('src/lab4/task1/files/films.txt'), {1: 'Мстители: Финал', 2: 'Хатико', 3: 'Дюна', 4: 'Унесенные призраками'})
        
    def test_check_history(self):
        self.assertEqual(self.recSystem.check_history('src/lab4/task1/files/history.txt'), [[2 ,1, 3], [1, 4, 3], [2, 2, 2, 2, 2, 3]])
